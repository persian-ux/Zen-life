...
export default function MedicationCard({ name, dosage, potency, time, taken, color = '#6b5bff', onToggleTake }: MedicationCardProps) {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.right}>
        ...
        <TouchableOpacity
          style={[styles.takeBtn, taken && styles.taken]}
          activeOpacity={0.8}
